...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'formaPtisis.date'
        db.add_column(u'ef421_formaptisis', 'date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'formaPtisis.date'
        db.delete_column(u'ef421_formaptisis', 'date')
