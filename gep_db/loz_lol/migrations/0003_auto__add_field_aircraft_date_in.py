...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aircraft.date_in'
        db.add_column(u'loz_lol_aircraft', 'date_in',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 2, 18, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aircraft.date_in'
        db.delete_column(u'loz_lol_aircraft', 'date_in')
    ...
    models = {
        u'loz_lol.aircraft': {
            ...
            'date_in': ('django.db.models.fields.DateTimeField', [], {}),
