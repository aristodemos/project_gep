...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Aircraft.ac_marks'
        db.alter_column(u'loz_lol_aircraft', 'ac_marks', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Aircraft.ac_flight_hours'
        db.alter_column(u'loz_lol_aircraft', 'ac_flight_hours', self.gf('django.db.models.fields.FloatField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Aircraft.ac_marks'
        db.alter_column(u'loz_lol_aircraft', 'ac_marks', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        u'loz_lol.aircraft': {
            ...
            'ac_flight_hours': ('django.db.models.fields.FloatField', [], {}),
            'ac_landings': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'ac_marks': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
