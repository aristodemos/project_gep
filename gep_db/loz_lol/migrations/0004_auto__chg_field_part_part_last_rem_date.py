...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Part.part_last_rem_date'
        db.alter_column(u'loz_lol_part', 'part_last_rem_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Part.part_last_rem_date'
        db.alter_column(u'loz_lol_part', 'part_last_rem_date', self.gf('django.db.models.fields.DateField')(null=True))
